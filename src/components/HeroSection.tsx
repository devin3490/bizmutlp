        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-block mb-6 px-5 py-2 rounded-full border border-bismuth-gold/30 bg-bismuth-gold/10 text-bismuth-gold text-sm md:text-base font-medium tracking-wide uppercase shimmer"
            >
